...
const SignUpAndLogin = (props) => {
    ...
    const [pageState, setPageState] = useState(props.stateName)
    ...
    function changeStateAndNavigateTo(nextState, link)
    {
                ...
                <Grid item>
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                {
                                    pageState === 'sign-up' ? <label>if you have already registered click <b className='text-blue-500' onClick={() => changeStateAndNavigateTo("login",linkToLoginPage)} >
                                        here</b></label> : <label>don't have an account? click <b className='text-blue-500' onClick={() => changeStateAndNavigateTo("sign-up",linkToRegisterPage)} >
                                        here</b></label>
                                }
